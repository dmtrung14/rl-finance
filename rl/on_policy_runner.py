...
class OnPolicyRunner:
    ...
    def __init__(self,
        ...
        self.policy_cfg['flat_terrain'] = 'flat' in self.cfg['experiment_name'] or 'manual' in self.cfg['experiment_name']
        ...
        actor_critic: ActorCritic = actor_critic_class( self.env.num_obs, 
                                                        num_critic_obs,
                                                        self.env.num_obs - self.env.cfg.env.n_proprio,
                                                        self.env.num_actions,
                                                        **self.policy_cfg).to(self.device)
      

        # Simon: I think this is where the PPO algorithm is initialized
